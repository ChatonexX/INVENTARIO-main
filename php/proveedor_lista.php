<?php
	...
	if(isset($busqueda) && $busqueda!=""){
		...
		$consulta_datos="SELECT * FROM proveedor WHERE nombre_proveedor LIKE '%$busqueda%' OR 
        celular LIKE '%$busqueda%' ORDER BY nombre_proveedor ASC LIMIT $inicio,$registros";

		$consulta_total="SELECT COUNT(id_prov) FROM proveedor WHERE nombre_proveedor LIKE '%$busqueda%' OR 
        celular LIKE '%$busqueda%'";

	}else{

		$consulta_datos="SELECT * FROM proveedor ORDER BY nombre_proveedor ASC LIMIT $inicio,$registros";

        $consulta_total="SELECT COUNT(id_prov) FROM proveedor";
