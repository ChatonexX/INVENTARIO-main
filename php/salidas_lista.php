<?php
	...
	$campos="producto.producto_id,producto.producto_descripcion,producto.producto_nombre,producto.producto_precio,producto.producto_stock,producto.producto_foto,producto.categoria_id,producto.usuario_id,categoria.categoria_id,categoria.categoria_nombre, proveedor.id_prov, proveedor.nombre_proveedor,usuario.usuario_id,usuario.usuario_nombre,usuario.usuario_apellido";
    
    //Cruce de Tablas

	if(isset($busqueda) && $busqueda!=""){

		$consulta_datos="SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=categoria.categoria_id INNER JOIN usuario ON producto.usuario_id=usuario.usuario_id INNER JOIN proveedor ON producto.id_prov=proveedor.id_prov WHERE producto.producto_descripcion LIKE '%$busqueda%' OR producto.producto_nombre LIKE '%$busqueda%' ORDER BY producto.producto_nombre ASC LIMIT $inicio,$registros";
		...
		$consulta_datos="SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=categoria.categoria_id INNER JOIN usuario ON producto.usuario_id=usuario.usuario_id INNER JOIN proveedor ON producto.id_prov=proveedor.id_prov WHERE producto.categoria_id='$categoria_id' ORDER BY producto.producto_nombre ASC LIMIT $inicio,$registros";

		$consulta_total="SELECT COUNT(producto_id) FROM producto WHERE categoria_id='$categoria_id'";

	}else{

		$consulta_datos="SELECT $campos FROM producto INNER JOIN categoria ON producto.categoria_id=categoria.categoria_id INNER JOIN usuario ON producto.usuario_id=usuario.usuario_id INNER JOIN proveedor ON producto.id_prov=proveedor.id_prov ORDER BY producto.producto_nombre ASC LIMIT $inicio,$registros";
			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
							...
							<strong>PROVEEDOR:</strong> '.$rows['nombre_proveedor'].', 
